...
export const TODOS_PAGE_DESCRIPTION =
  'Demonstrating Eden Treaty + TanStack Query with queries, mutations, and SSE subscriptions'
...
export const LIST_LOADING = 'Loading todos...'
...
export const IMPLEMENTATION_QUERY =
  'Using useQuery and useMutation with Eden Treaty for type-safe data fetching.'
